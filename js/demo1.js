(function() {
    ...
    var sliderCanvas = document.querySelector('.donji .pieces-slider__canvas');
    var imagesEl = [].slice.call(document.querySelectorAll('.donji .pieces-slider__image'));
    var textEl = [].slice.call(document.querySelectorAll('.donji .pieces-slider__text'));

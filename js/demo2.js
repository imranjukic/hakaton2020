(function() {
    ...
    var sliderCanvas = document.querySelector('.treci .pieces-slider__canvas');
    var imagesEl = [].slice.call(document.querySelectorAll('.treci .pieces-slider__image'));
    var textEl = [].slice.call(document.querySelectorAll('.treci .pieces-slider__text'));

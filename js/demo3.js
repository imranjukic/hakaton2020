(function() {
    ...
    var sliderCanvas = document.querySelector('.cetvrti .pieces-slider__canvas');
    var imagesEl = [].slice.call(document.querySelectorAll('.cetvrti .pieces-slider__image'));
    var textEl = [].slice.call(document.querySelectorAll('.cetvrti .pieces-slider__text'));

(function() {
    ...
    var sliderCanvas = document.querySelector('.josDonji .pieces-slider__canvas');
    var imagesEl = [].slice.call(document.querySelectorAll('.josDonji .pieces-slider__image'));
    var textEl = [].slice.call(document.querySelectorAll('.josDonji .pieces-slider__text'));

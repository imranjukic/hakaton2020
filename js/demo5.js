(function() {
    ...
    var sliderCanvas = document.querySelector('.josTreci .pieces-slider__canvas');
    var imagesEl = [].slice.call(document.querySelectorAll('.josTreci .pieces-slider__image'));
    var textEl = [].slice.call(document.querySelectorAll('.josTreci .pieces-slider__text'));
    ...
    var textOptions = {
        ...
        translate: function() {
            if (windowWidth > 1120) return {translateX: 100, translateY: 100};
    ...
    function initEvents() {
        ...
        //document.querySelector('.donji .pieces-slider__button--prev').addEventListener('click', prevItem);
        //document.querySelector('.donji .pieces-slider__button--next').addEventListener('click', nextItem);
